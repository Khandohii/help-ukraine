...
function custom_theme_options() {
	...
	$custom_settings = array(
		...
		'sections'        => array(
			...
			array(
				'id'    => 'sing_or_donate',
				'title' => 'Підпишись або задонать?',
			),
			array(
				'id'    => 'rest_and_study',
				'title' => 'Відпочивай та навчайся',
			),
			array(
				'id'    => 'products',
				'title' => 'Купуй для перемоги',
			),
			array(
				'id'    => 'option_types',
				'title' => __( 'Option Types', 'theme-text-domain' ),
		...
		'settings'        => array(
			...
			array(
				'id'           => 'amount_donations_on_off',
				'label'        => 'Показать/скрыть секцию',
				'desc'         => '',
				'std'          => 'on',
				'type'         => 'on-off',
				'section'      => 'amount_donations',
			),
			array(
				'id'           => 'amount_donations_title',
				'label'        => 'Заголовок',
				'desc'         => '',
				'std'          => '',
				'type'         => 'text',
			...
			array(
				'id'           => 'amount_donations_currency',
				'label'        => 'Валюта',
				'desc'         => 'Оберіть тип валюти',
				'std'          => '',
				'type'         => 'select',
				'section'      => 'amount_donations',
				'choices'      => array(
			...
			array(
				'id'           => 'amount_donations_target_sum',
				'label'        => 'Цільова сума сбору',
				'desc'         => '0',
				'std'          => '',
				'type'         => 'text',
				'section'      => 'amount_donations',
			...
			array(
				'id'           => 'requisites_info_tab',
				'label'        => 'Информация секции',
				'desc'         => '',
				'type'         => 'tab',
				'section'      => 'requisites',
			),
			array(
				'id'           => 'requisites_on_off',
				'label'        => 'Показать/скрыть секцию',
				'desc'         => '',
				'std'          => 'on',
				'type'         => 'on-off',
			...
			array(
				'id'           => 'requisites_privat_link',
				'label'        => 'Ссылка на кнопку privatbank',
				'desc'         => '',
				'std'          => '',
				'type'         => 'text',
				'section'      => 'requisites',
			...
			array(
				'id'           => 'requisites_list_tab',
				'label'        => 'Список реквизитов',
				'desc'         => '',
				'type'         => 'tab',
				'section'      => 'requisites',
			),
			array(
				'id'           => 'requisites_list_items',
				'label'        => 'Список реквизитов',
				'desc'         => '',
				'std'          => '',
				'type'         => 'list-item',
				...
				'settings'     => array(
					array(
						'id'           => 'requisites_list_item_content',
						'label'        => 'Текст реквизита',
						'desc'         => '',
						'std'          => '',
						'type'         => 'textarea',
						'rows'         => '10',
			...
			array(
				'id'           => 'sing_or_donate_on_off',
				'label'        => 'Показать/скрыть секцию',
				'desc'         => '',
				'std'          => 'on',
				'type'         => 'on-off',
				'section'      => 'sing_or_donate',
			),
			array(
				'id'           => 'sing_or_donate_title',
				'label'        => 'Заголовок',
				'desc'         => '',
				'std'          => '',
				'type'         => 'text',
			...
			array(
				'id'           => 'sing_or_donate_sign_list_items',
				'label'        => 'Підписатись на регулярні платежі',
				'desc'         => '',
				'std'          => '',
				'type'         => 'list-item',
				'section'      => 'sing_or_donate',
				'settings'     => array(
					array(
						'id'           => 'sing_or_donate_sign_list_item_link',
			...
			array(
				'id'           => 'sing_or_donate_donate_list_items',
				'label'        => 'Задонатити разово',
				'desc'         => '',
				'std'          => '',
				'type'         => 'list-item',
				'section'      => 'sing_or_donate',
				'settings'     => array(
					array(
						'id'           => 'sing_or_donate_donate_list_item_link',
						'label'        => 'Посилання для переходу',
						'desc'         => '',
						'std'          => '',
						'type'         => 'text',
			...
			array(
				'id'           => 'sing_or_donate_tg_info',
				'label'        => 'Текст до інфо блоку',
				'desc'         => '',
				'std'          => '',
				'type'         => 'text',
				'section'      => 'sing_or_donate',
			...
			array(
				'id'           => 'sing_or_donate_tg_link',
				'label'        => 'Посилання на телеграм акаунт',
				'desc'         => '',
				'std'          => '',
				'type'         => 'text',
				'section'      => 'sing_or_donate',
			...
			array(
				'id'           => 'rest_and_study_on_off',
				'label'        => 'Показать/скрыть секцию',
				'desc'         => '',
				'std'          => 'on',
				'type'         => 'on-off',
				'section'      => 'rest_and_study',
			),
			array(
				'id'           => 'rest_and_study_title',
				'label'        => 'Заголовок',
				'desc'         => '',
				'std'          => '',
				'type'         => 'text',
			...
			array(
				'id'           => 'rest_and_study_list_items',
				'label'        => 'Івенти',
				'desc'         => 'Тут можна редагувати список івентів',
				'std'          => '',
				'type'         => 'list-item',
				'section'      => 'rest_and_study',
				'settings'     => array(
					array(
						'id'           => 'rest_and_study_list_item_img',
						'label'        => 'Зображення',
						'desc'         => '',
						'std'          => '',
						'type'         => 'upload',
					...
					array(
						'id'           => 'rest_and_study_list_item_desc',
						'label'        => 'Опис',
						'desc'         => '',
						'std'          => '',
						'type'         => 'text',
					...
					array(
						'id'           => 'rest_and_study_list_item_price',
						'label'        => 'Ціна',
						'desc'         => '',
						'std'          => '',
						'type'         => 'text',
					...
					array(
						'id'           => 'rest_and_study_list_item_link',
						'label'        => 'Посилання для переходу',
						'desc'         => '',
						'std'          => '',
						'type'         => 'text',
			...
			array(
				'id'           => 'products_list_items',
				'label'        => 'Товари',
				'desc'         => 'Тут можна редагувати список товарів',
				'std'          => '',
				'type'         => 'list-item',
				'section'      => 'products',
				'settings'     => array(
