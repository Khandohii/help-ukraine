					...
					array(
						...
						'pages' => array(
							array(
								...
								'page_title'      => apply_filters( 'ot_theme_options_page_title', esc_html__( 'Настройки темы', 'option-tree' ) ),
								'menu_title'      => apply_filters( 'ot_theme_options_menu_title', esc_html__( 'Настройки темы', 'option-tree' ) ),
								'capability'      => $caps,
								...
								'updated_message' => apply_filters( 'ot_theme_options_updated_message', esc_html__( 'Настройки обновлены.', 'option-tree' ) ),
								'reset_message'   => apply_filters( 'ot_theme_options_reset_message', esc_html__( 'Настройки сброшены.', 'option-tree' ) ),
								'button_text'     => apply_filters( 'ot_theme_options_button_text', esc_html__( 'Сохранить изменения', 'option-tree' ) ),
