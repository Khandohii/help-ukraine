	...
	function ot_type_gallery( $args = array() ) {
		...
		if ( ! empty( $ids ) ) {
			...
			<div class="ot-gallery-buttons">
				<a href="#" class="option-tree-ui-button button button-secondary hug-left ot-gallery-delete">' . esc_html__( 'Удалить галерею', 'option-tree' ) . '</a>
				<a href="#" class="option-tree-ui-button button button-primary right hug-right ot-gallery-edit">' . esc_html__( 'Редактировать галерею', 'option-tree' ) . '</a>
			</div>';
			...
			echo '
			<div class="ot-gallery-buttons">
				<a href="#" class="option-tree-ui-button button button-primary right hug-right ot-gallery-edit">' . esc_html__( 'Создать галерею', 'option-tree' ) . '</a>
			</div>';
...
if ( ! function_exists( 'ot_type_list_item' ) ) {
	...
	function ot_type_list_item( $args = array() ) {
		...
		// Button.
		echo '<a href="javascript:void(0);" class="option-tree-list-item-add option-tree-ui-button button button-primary right hug-right" title="' . esc_html__( 'Добавить', 'option-tree' ) . '">' . esc_html__( 'Добавить', 'option-tree' ) . '</a>';

		// Description.
		$list_desc = $sortable ? __( 'Вы можете изменить порядок с помощью перетаскивания, порядок обновится после сохранения.', 'option-tree' ) : '';
